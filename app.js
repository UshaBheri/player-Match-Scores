...
app.get("/players/:playerId/playerScores/", async (request, response) => {
  ...
  response.send(
    playerScore.map((eachPlayerScore) => ({
      playerId: eachPlayerScore.player_id,
      playerName: eachPlayerScore.player_name,
      totalScore: eachPlayerScore.total_score,
      totalFours: eachPlayerScore.total_fours,
      totalSixes: eachPlayerScore.total_sixes,
    }))
  );
});
module.exports = app;
